...
class MiniObServer:
    ...
    def __init__(self, base_dir: str, data_dir: str, config_file: str, server_port: int, server_socket: str,
                 clean_data_dir: bool):
...
class TestSuite:
    ...
    def set_test_result_tmp_dir(self, test_result_tmp_dir: str):
        ...
        if not (os.path.isdir(test_result_tmp_dir)):
            raise (Exception(
                "Failed to set test result temp directory. " + test_result_tmp_dir + " is not a directory or failed to create"))
